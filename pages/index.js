...
export default function Home() {
  ...
  const handleClick = async event => {
    ...
    if (urlTwitter.includes('twitter.com') == false ) {
      ...
      `<form method="get" action='https://kutip.vercel.app/tweet/${statusId}'} value=""></div>` +
      `<button class="inline-flex outline-none  items-center text transform hover:scale-105 m-auto px-8 py-2 text-base font-semibold rounded-lg text-snow-storm bg-gradient-to-r from-aurora-orange to-aurora-yellow""> ` +       
